...
import { QuestionMediaGallery } from '../components/QuestionMediaFigure'
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
        <QuestionMediaGallery media={currentExercise.media} mediaGallery={currentExercise.mediaGallery} />
